...
Since the application is running in OpenShift, its system prompt exist as a configmap so it is easy to view and update without having to rebuild the front end. 
